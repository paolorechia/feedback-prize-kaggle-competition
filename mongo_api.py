...
class MongoDataAPIClient:
    ...
    def register_st_training_context(self, training_context: TrainingContext):
        data = {
            "document": {
                ...
                "training_batch_size": training_context.training_batch_size,
                "evaluation_batch_size": training_context.evaluation_batch_size,
    ...
    def append_all_score(self, unique_id, all_score, memory_usage):
        data = {
            "filter": {"unique_id": unique_id},
            "update": {
                "$push": {
                    f"mcrmse_scores.all": all_score,
